function Tamagochi(name) {
	...
	this.eat = function () {
		...
		console.log(name, " is ate! And now the indicators show us the following results: ");
		this.status();
	}

	this.sleep = function () {
		if (this.happiness == 100 || this.health == 100 || this.boredom == 100 || this.age == 100) {
			this.happiness += 0;
			this.health += 0;
			this.boredom += 0;
			this.age += 0;
		...
		console.log(name, " is slept! And now the indicators show us the following results: ");
		this.status();
	}
	...
	this.swim = function () {
		...
		console.log(name, "is swam! And now the indicators show us the following results: ");
		this.status();
	}
	...
	this.play = function () {
		...
		console.log(name, "is played! And now the indicators show us the following results: ");
		this.status();
	}
	...
	this.education = function () {
		...
		console.log(name, "is learned! And now the indicators show us the following results: ");
		this.status();
	}
	this.fell = function () {
		...
		console.log(name, "is fell! And now the indicators show us the following results: ");
		this.status();
	}
	...
	this.accidentallyDisappearedInTheForest = function () {
		...
		this.age = undefined;
		this.status();
		console.log("Sorry, but your Pikachu accidentally disappeared in the forest...")
		// breakTimer		
	}
